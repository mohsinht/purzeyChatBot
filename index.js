...
admin.initializeApp({
	credential: admin.credential.cert({
		projectId: 'purzey-b9cbd', #ignoreline
		...
		clientEmail: "firebase-adminsdk-f5le9@purzey-b9cbd.iam.gserviceaccount.com", #ignoreline
	}),
	storageBucket: 'purzey-b9cbd.appspot.com', #ignoreline
	databaseURL: 'https://purzey-b9cbd.firebaseio.com' #ignoreline
});
...
let token = "EAACzZALUsmqYBAIeJ1IHeFXticRO0Ac7LEXbuaUe6pxwUoMZBi3EvHK4kMC4TjXAgbvZAZAudmi5qabXtGKCfJ13NZCeNk9petjkG7x48vWJZBvVgbdsEOwnAzaASwRmZCpSAtmbLHRE7jSxsYV0ZCfmSFwDUgI3zSQNZB3ZASTR1zwgZDZD" #ignoreline
